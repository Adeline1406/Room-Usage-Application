...
function showOccupancy(roomUsageList, prop) {
	...
	let newOccupancy =
		"<div class=\"mdl-cell mdl-cell--4-col\"><table class=\"mdl-data-table mdl-js-data-table mdl-shadow--2dp\"><thead><tr><th class=\"mdl-data-table__cell--non-numeric\"><h5>" +
		"Worst occupancy for " + prop + "</h5></th></tr></thead><tbody>";
	let listLength = 0;
	...
	for (let index = 0; index < listLength; index++) {
		...
		newOccupancy +=
			"<tr><td class=\"mdl-data-table__cell--non-numeric\"><div><b>" + roomUsageInstance.buildingAddress + "</b></div> <div>Occupancy: " + (
				roomUsageInstance.occupancy * 100).toFixed(1) + " % </div><div>Heating/cooling: " + heatCoolOnOff + "</div> <div>Lights: " + lightsOnOff +
			"</div> <div><font color=\"grey\"><i>" + dateString + ", " + timeString + "</i></font></div> </td></tr></tbody>"
	}
